...
export class AppComponent implements AfterViewInit {
  ...
  public appPages = [
    ...
    { title: 'Eventos', url: 'eventos', icon: 'balloon' },
    { title: 'Orcamento', url: 'orcamentos', icon: 'cash' },
    { title: 'Feedback', url: 'feedback', icon: 'star' },
    { title: 'Cadastro', url: 'addcliente', icon: 'clipboard' },
    { title: 'Login', url: 'logincliente', icon: 'log-in' },
